        ...
        >
            ...
            >
                    ...
                    <div className='flex items-center gap-2 sm:gap-4'>
                        {client?._id && (
                            <button
                                ...
                                className="flex items-center gap-2 px-3.5 py-2 rounded-lg border border-neutral-100/50 hover:bg-white hover:shadow-sm transition-all active:scale-95 cursor-pointer"
                        ...
                        <button
                            onClick={() => setIsActive(false)}
                            className='w-10 h-10 rounded-lg flex items-center justify-center hover:bg-neutral-50 transition-colors active:scale-90 group'
                        >
                    ...
                    {purchases.length === 0 ? (
                        ...
                        <div className='flex flex-col gap-8'>
                            ...
                            <div className='space-y-6'>
                                ...
                                <div className='p-4 border rounded-lg' style={{ borderColor: colors.light[300], backgroundColor: colors.light[100] }}>
                ...
                <div className='p-5 border-t space-y-2 z-10' style={{ borderColor: colors.light[300], backgroundColor: colors.light[100] }}>
                    <button
                        className={`w-full h-12 rounded-lg font-bold text-xs uppercase tracking-widest transition-all active:scale-[0.99] flex items-center justify-center cursor-pointer ${confirmBTNWorks ? "hover:brightness-110" : "opacity-30 cursor-not-allowed grayscale"
                            }`}
