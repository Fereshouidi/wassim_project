        ...
        >
            ...
            >
                ...
                {verificationAccountBannerVisible &&
                    <div className='w-full h-full rounded-sm- overflow-hidden bg-transparent- backdrop:blur-2xl fixed top-0 left-0 flex justify-center items-center overflow-y-scroll- z-50'>
                        <div
                            className={`${screenWidth > 1000 ? "w-[450px]" : "w-[350px]"} h-full- max-h-[90%] rounded-sm- overflow-hidden relative`}
                            onClick={(e) => e.stopPropagation()}
                            style={{
