...
const SignUp = ({
        ...
        await axios.post(backEndUrl + "/addClient", {
            ...
            .catch(err => {
                setStatusBanner(
                    ...
                    null,
                    <div
                        className='w-full h-full bg-red-500- p-10 rounded-lg flex flex-col justify-center items-center'
                        style={{
    ...
    return (
        <div
            className="w-full h-full overflow-y-auto flex flex-col items-center bg-white rounded-lg p-8 shadow-2xl scrollbar-hidden transition-all duration-300"
            style={{
                backgroundColor: colors.light[100],
            }}
        >
            ...
            <div className="mb-6 flex flex-col items-center">
                <div
                    className="w-16 h-16 rounded-lg flex items-center justify-center mb-4 shadow-inner"
