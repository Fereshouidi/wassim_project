        ...
        >
            ...
            >
                    ...
                    >
                        ...
                        >
                            <span
                                ...
                                className='w-full h-full flex items-center gap-3 px-5 rounded-lg font-bold transition-all duration-300 hover:scale-[1.02]'
                                style={{
                ...
                <div className='w-full h-fit flex flex-col'>
                    ...
                    <div
                        className='w-full bg-red-500- mb-0 p-3 pt-8- bg-red-500- rounded-lg flex justify-start items-center fixed- bottom-5- cursor-pointer transition-colors duration-200'
                        style={{
