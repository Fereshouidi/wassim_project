                            ...
                            >
                                {availableBases.map(base => (
                                    <motion.div
                                        ...
                                        className="relative rounded-lg cursor-pointer flex flex-col items-center justify-center py-5 px-2 transition-all"
                                        style={{
                                    ...
                                    >
                                        <div className="w-12 h-12 mb-2 relative">
                                            {getCurrentThumbnail(base) ? (
                                                <Image src={getCurrentThumbnail(base)!} alt="" fill className="object-contain rounded-lg" sizes="48px" />
                                            ) : (
                                                <div className="w-full h-full rounded-lg" style={{ backgroundColor: base.chainColor }} />
                                            )}
                                        </div>
                                    ...
                                    >
                                        <div className="w-12 h-12 mb-2 relative">
                                            {getCurrentThumbnail(charm) ? (
                                                <Image src={getCurrentThumbnail(charm)!} alt="" fill className="object-contain rounded-lg" sizes="48px" />
                                            ) : (
                ...
                {placedCharms.length > 0 && (
                    <div className="px-6 py-4 flex-shrink-0 sticky bottom-[80px] lg:bottom-0" style={{ backgroundColor: bg2, borderTop: `1px solid ${border1}` }}>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {selectedBase && (
                                <div className="w-10 h-10 rounded-lg relative p-1.5" style={{ backgroundColor: bgTab, border: `1px solid ${border1}` }}>
                                    {getCurrentThumbnail(selectedBase) ? (
                                        <Image src={getCurrentThumbnail(selectedBase)!} alt="" fill className="object-contain" sizes="30px" />
                                    ) : (
                                        <div className="w-full h-full rounded-lg" style={{ backgroundColor: selectedBase.chainColor }} />
                                    )}
                                </div>
                            )}
                            {placedCharms.map(pc => {
                                const charm = availableCharms.find(c => c.id === pc.charmId);
                                return charm ? (
                                    <div key={pc.instanceId} className="w-10 h-10 rounded-lg relative p-1.5" style={{ backgroundColor: bgTab }}>
                                        {getCurrentThumbnail(charm, pc.specId) ? (
                                            <Image src={getCurrentThumbnail(charm, pc.specId)!} alt="" fill className="object-contain rounded-lg" sizes="30px" />
                                        ) : (
                ...
                <div className="px-6 py-4 sticky bottom-0 z-[60]" style={{ backgroundColor: bg2, borderTop: `1px solid ${border1}` }}>
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="flex-1 py-3 rounded-lg flex items-center justify-center gap-3 shadow-xl-"
                            ...
                            >
                                {getCurrentThumbnail(selectedBase) ? (
                                    <div className="absolute inset-0 pointer-events-none drop-shadow-xl">
                                        <Image src={getCurrentThumbnail(selectedBase)!} alt="" fill className="object-contain rounded-lg" sizes="(max-width: 1024px) 85vw, 550px" priority />
                                    </div>
                                ) : (
