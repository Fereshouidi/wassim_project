...
const CustomSelect = ({
    ...
    return (
        <div
            className={`min-w-[170px] relative cursor-pointer no-sellect border-[0.02px] rounded-lg duration-300 ${className}`}
            style={{
        ...
        >
            <div className='w-full h-7 rounded-lg px-1 py-5 z-10 flex flex-row justify-between items-center'>
