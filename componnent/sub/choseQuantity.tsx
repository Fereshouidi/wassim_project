...
const ChoseQuantity = ({
    ...
    return (
        <div className=' flex justify-between items-center gap-2'>
            ...
            <img
                className='w-10 h-10 p-3 flex justify-center items-center rounded-lg text-2xl font-extrabold cursor-pointer'
            ...
            <span
                className='w-10 h-10 p-3 flex justify-center items-center rounded-lg '
            >{quantity}</span>
