                    ...
                    >
                        ...
                        >
                            {products.map((product, index) => (
                                <div
                                    key={index}
                                    className=' h-[290px] h-fit- bg-red-500- sm:h-[370px] m-2- px-2 rounded-lg overflow-hidden'
                                    style={{
                                        width: cardWidth + "px",
                                    }}
                                >
                        ...
                        {productLoadingShowUp && (
                            <div
                                ref={productLoading}
                                className=' h-[290px] h-fit- bg-red-500- sm:h-[390px] m-2- px-2 rounded-lg overflow-hidden'
                                style={{
                                    width: cardWidth + "px",
                                }}
                            >
                                <ProductLoading
                                    ...
                                    className=' h-[250px] h-fit- bg-red-500- sm:h-[330px] m-2- px-2 rounded-lg overflow-hidden'
                                />
                            </div>
                        )}
                    </div>
