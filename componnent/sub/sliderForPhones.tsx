                    ...
                    >
                        ...
                        >
                            {products.map((product, index) => (
                                <div
                                    key={index}
                                    className='w-[180px] sm:w-[250px] py-2 h-full- flex justify-center items-center bg-red-500- rounded-lg overflow-hidden'
                                >
                                    <ProductCard
                                        product={product}
                                        className='w-[95%] h-[270px] rounded-lg overflow-hidden'
                                        useLike={useLike}
                                    />
                                </div>
                            ))}
