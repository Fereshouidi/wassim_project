...
const AiPromoBanner = () => {
    ...
    return (
        ...
        >
            <div
                className="relative w-full max-w-6xl mx-auto rounded-lg overflow-hidden cursor-pointer group"
            ...
            >
                ...
                <div className="absolute -inset-[1px] rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-700 -z-10 blur-sm"
                ...
                <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6 p-8 sm:p-10">
                    ...
                    >
                        <div
                            className="flex items-center gap-3 px-7 py-4 rounded-lg text-white font-black text-sm shadow-xl group-hover:shadow-2xl group-hover:-translate-y-0.5 transition-all duration-300"
                            style={{
