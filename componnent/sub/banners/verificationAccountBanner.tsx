...
const VerificationAccountBanner = ({
    ...
    if (!clientFound) return (
        <div className='w-full h-full flex flex-col justify-center items-center rounded-sm- p-8 transition-all duration-300' style={{ backgroundColor: colors.light[100] }}>
            <X
            ...
            <div className='w-full flex flex-col items-center animate-in slide-in-from-bottom-4 duration-500'>
                <div className="w-16 h-16 bg-indigo-50 dark:bg-indigo-900/20 rounded-sm- flex items-center justify-center mb-6 shadow-sm border border-indigo-100/50">
    ...
    return (
        <div className='w-full h-full flex flex-col justify-center items-center rounded-sm- p-8 transition-all duration-300' style={{ backgroundColor: colors.light[100] }}>
            ...
            <div className='w-full flex flex-col items-center animate-in slide-in-from-bottom-4 duration-500'>
                <div className="w-16 h-16 bg-green-50 dark:bg-green-900/20 rounded-sm- flex items-center justify-center mb-6 shadow-sm border border-green-100/50">
