...
const OrdersSectionHeader = ({
    ...
    const renderTabs = () => (
        <div
            className='w-full sm:w-fit flex items-center p-1 rounded-lg shadow-inner border'
            style={{
            ...
            {tabs.map((tab) => {
                ...
                return (
                    <button
                        ...
                        className={`relative flex items-center justify-center gap-1.5 px-3 sm:px-5 py-2 sm:py-2.5 rounded-lg sm:rounded-lg text-[9px] sm:text-[11px] font-semibold uppercase tracking-wider transition-all duration-500`}
                        style={{
                    ...
                    >
                        {isActive && (
                            <motion.div
                                ...
                                className="absolute inset-0 rounded-lg sm:rounded-lg shadow-lg"
                                style={{
    ...
    const renderPagination = () => (
        ...
        >
            <button
                ...
                className='w-7 h-7 sm:w-9 sm:h-9 flex items-center justify-center rounded-lg sm:rounded-lg hover:bg-black hover:bg-opacity-5 transition-all active:scale-90 disabled:opacity-20'
            >
                <img
            ...
            <div
                className='flex flex-col items-center justify-center px-2 sm:px-4 h-7 sm:h-9 rounded-lg sm:rounded-lg border border-dashed'
