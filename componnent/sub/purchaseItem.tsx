...
const PurchaseItem = ({ purchase, setPurchases }: Props) => {
    ...
    return (
        <div
            className='group flex gap-3 p-3 rounded-lg border transition-all hover:border-gray-400 bg-white cursor-pointer'
            style={{
        ...
        >
            {/* Thumbnail */}
            <div className="w-22 h-22 flex-shrink-0 overflow-hidden rounded-lg bg-gray-50 border" style={{ borderColor: colors.light[200] }}>
                <img
                    //@ts-ignore
            ...
            <div className='flex-1 flex flex-col justify-between py-1'>
                ...
                <div className='flex justify-between items-end mt-2'>
                    <div className='flex items-center border rounded-lg h-7' style={{ borderColor: colors.light[300] }}>
                        <button
