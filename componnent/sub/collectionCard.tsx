...
const CollectionCard = ({
    ...
    return (
        <motion.div
            ...
            className={`w-[320px] sm:w-[250px] max-h-[320px] sm:max-h-[270px] rounded-lg overflow-hidden transition-all duration-500 group ${isLoading ? 'cursor-default' : 'cursor-pointer'}`}
            style={{
