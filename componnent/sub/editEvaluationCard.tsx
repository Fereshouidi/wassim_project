...
const AddEvaluationCard = ({
    ...
    return (
        ...
        >
            <div
                className='w-full max-w-[450px] h-fit p-6 rounded-lg shadow-2xl transition-all scale-up'
                style={{
            ...
            >
                ...
                <div className='mb-6'>
                    <textarea
                        className='w-full p-3 rounded-lg border outline-none min-h-[120px] text-sm resize-none transition-all focus:ring-1'
                ...
                <div className='flex flex-row-reverse gap-3'>
                    <button
                        className='flex-1 py-3 rounded-lg font-bold transition-all active:scale-95 text-sm cursor-pointer'
                        style={{
                    ...
                    <button
                        className='flex-1 py-3 rounded-lg font-bold border transition-all active:scale-95 text-sm cursor-pointer'
                        style={{
                            borderColor: colors.light[300],
                            color: colors.dark[100]
                        }}
