...
const MoreBotton = ({
    ...
    return (
        <div
            className='w-44 h-10 border text-sm sm:-text-md cursor-pointer mt-0 rounded-lg flex justify-center items-center overflow-hidden transition-all duration-300'
            style={{
