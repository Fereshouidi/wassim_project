    ...
    return (
        ...
        >
            ...
            <div className="relative mb-8">
                ...
                />
                <div
                    className="relative w-24 h-24 rounded-lg flex items-center justify-center border shadow-xl"
                    style={{
            ...
            <div className="text-center max-w-md">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                        href="/"
                        className="flex items-center justify-center gap-2 px-8 py-4 rounded-lg font-black text-[11px] uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-md"
                        style={{
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-8 py-4 rounded-lg font-black text-[11px] uppercase tracking-widest border transition-all hover:bg-current/5 active:scale-95"
