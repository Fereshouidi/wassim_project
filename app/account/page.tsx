...
const AccountPage = () => {
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className='w-full max-w-5xl flex flex-col rounded-lg overflow-hidden transition-all duration-300'
                    style={{
                    ...
                    <div className='p-4 sm:p-10'>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8 w-full'>
                            ...
                            <CustomInputText
                                ...
                                inputClassName='w-full px-4 py-3 rounded-lg border  rounded transition-all  bg-transparent'
                            ...
                            <CustomInputText
                                ...
                                inputClassName='w-full px-4 py-3 rounded-lg  rounded transition-all  bg-transparent'
                            ...
                            <CustomInputText
                                ...
                                inputClassName='w-full px-4 py-3 rounded-lg border border-gray-200   rounded transition-all  bg-transparent'
                        ...
                        <div className='w-full mt-12 flex flex-col-reverse sm:flex-row items-center justify-between gap-6 pt-8 border-t border-gray-100 dark:border-gray-800'>
                            ...
                            {/* Logout Button */}
                            <button
                                className='group flex items-center justify-center gap-3 px-8 py-3 rounded-lg text-red-500 font-bold hover:bg-red-50 dark:hover:bg-red-950/30 transition-all duration-300 w-full sm:w-auto active:scale-95 border border-transparent hover:border-red-100 dark:hover:border-red-900/30'
                            ...
                            {/* Submit Button */}
                            <button
                                className='w-full sm:w-auto min-w-[200px] flex justify-center items-center py-4 px-10 rounded-lg font-black text-white shadow-xl hover:-translate-y-1 active:translate-y-0 transition-all duration-300 active:scale-[0.98]'
                                style={{
            ...
            {verificationAccountBannerVisible &&
                <div className='fixed inset-0 z-50 flex justify-center items-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200'>
                    <div
                        className="w-full max-w-md relative bg-white rounded-lg shadow-2xl overflow-hidden"
